...
if(substr(basename($_SERVER['PHP_SELF']), 0, 11) == "imEmailForm") {
	...
	if(@$_POST['action'] != 'check_answer') {
		if(!isset($_POST['imJsCheck']) || $_POST['imJsCheck'] != 'E15C92680F3081D1572ACF6D7DE6D9E1' || (isset($_POST['imSpProt']) && $_POST['imSpProt'] != ""))
			die(imPrintJsError());
		$form->mailToOwner($_POST['email'] != "" ? $_POST['email'] : 'theredshedtally@gmail.com', 'theredshedtally@gmail.com', '', '', false);
		$form->mailToCustomer('theredshedtally@gmail.com', $_POST['email'], 'Thanks,  I have received your email', 'I will be replying soon.
